...
export default function Home() {
  ...
  */
  ...
  return (
    <div>
      <Head>
        <title>AxolotlSwap</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/axolotl-64.png" />
      </Head>
      <div className={styles.main}>
        <div>
          
          <h1 className={styles.title}>Welcome to AxlotlSwap Exchange Version 1!</h1>
          <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="./default.png" />
        </div>
      </div>

      <footer className={styles.footer}>
        Made with &#10084; by Shivansh Kumar (8th Sem Major Project)
      </footer>
